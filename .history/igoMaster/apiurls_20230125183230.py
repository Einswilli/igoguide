...
urlpatterns=[
    ...
    #####   LES PAYMENTS
    #####
    path('medias/save', api.PAYMENT.save),
    path('medias/list', api.PAYMENT.list),
    path('medias/show/<int:id>', api.PAYMENT.show),
    path('medias/delete/<int:id>', api.PAYMENT.delete),
